...
}("undefined" != typeof window ? window : this, function (a, b)
{
                    ...
                    } : function (b, c, i)
                    {
                        ...
                        if (q) {
                            ...
                            if (o = [g ? q.firstChild : q.lastChild], g && s) {
                                ...
                                if (s && (m = b, l = m[u] || (m[u] = {}), k = l[m.uniqueID] || (l[m.uniqueID] = {}), j = k[a] || [], n = j[0] === w && j[1], t = n), t === !1)while (m = ++n && m && m[p] || (t = n = 0) || o.pop())if ((h ? m.nodeName.toLowerCase() === r : 1 === m.nodeType) && ++t && (s && (l = m[u] || (m[u] = {}), k = l[m.uniqueID] || (l[m.uniqueID] = {}), k[a] = [w, t]), m === b))break;
    ...
    {
        for (var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], o = 0, p = a.length; p > o; o++)if (f = a[o], f || 0 === f)if ("object" === n.type(f))n.merge(m, f.nodeType ? [f] : f); else
            if (ba.test(f)) {
        ...
        l.textContent = "", o = 0;
        while (f = m[o++])if (d && n.inArray(f, d) > -1)e && e.push(f); else
    ...
    function ja(a, b, c, d, e, f)
    {
        ...
        if (null == d && null == e ? (e = c, d = c = void 0) : null == e && ("string" == typeof c ? (e = d, d = void 0) : (e = d, d = c, c = void 0)), e === !1)e = ha; else
            if (!e)return this;
    ...
    function zb(a, b, c, d)
    {
        ...
        f = k.shift();
        while (f)if (a.responseFields[f] && (c[a.responseFields[f]] = b), !i && d && a.dataFilter && (b = a.dataFilter(b, a.dataType)), i = f, f = k.shift())if ("*" === f)f = i; else
            if ("*" !== i && i !== f) {
    ...
    function Fb(a, b, c, d)
    {
        ...
        if (n.isArray(b))n.each(b, function (b, e)
        {
            ...
            if (c || "object" !== n.type(b))d(a, b); else for (e in b)Fb(a + "[" + e + "]", b[e], c, d)
    }
